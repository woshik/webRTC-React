...
const Peer = (props) => {
  ...
  const micEnabled = Boolean(micConsumer) && !micConsumer.locallyPaused && !micConsumer.remotelyPaused;

  const videoVisible = Boolean(webcamConsumer) && !webcamConsumer.locallyPaused && !webcamConsumer.remotelyPaused;

  const screenVisible = Boolean(screenConsumer) && !screenConsumer.locallyPaused && !screenConsumer.remotelyPaused;
  ...
  return (
    <React.Fragment>
      <div
        className={classnames(classes.root, 'webcam', hover ? 'hover' : null, activeSpeaker ? 'active-speaker' : null)}
        ...
        <div className={classnames(classes.viewContainer)}>
          {!videoVisible && (
            <div className={classes.videoInfo}>
              <p>
                <FormattedMessage id="room.videoPaused" defaultMessage="This video is paused" />
              </p>
            </div>
          )}
          ...
          >
            ...
            >
              {smallContainer ? (
                ...
                >
                  {micEnabled ? <VolumeUpIcon /> : <VolumeOffIcon />}
                </IconButton>
              ) : (
                <Fab
                  aria-label={intl.formatMessage({
              ...
              >
                {smallContainer ? (
                  <IconButton
                    ...
                    className={classes.smallContainer}
                    disabled={!videoVisible || windowConsumer === webcamConsumer.id}
                    size="small"
                    color="primary"
                    onClick={() => {
          ...
          <VideoView
            ...
            consumerCurrentSpatialLayer={webcamConsumer ? webcamConsumer.currentSpatialLayer : null}
            consumerCurrentTemporalLayer={webcamConsumer ? webcamConsumer.currentTemporalLayer : null}
            consumerPreferredSpatialLayer={webcamConsumer ? webcamConsumer.preferredSpatialLayer : null}
            consumerPreferredTemporalLayer={webcamConsumer ? webcamConsumer.preferredTemporalLayer : null}
          ...
          >
            <div className={classnames(classes.viewContainer)}>
                  ...
                  >
                    {smallContainer ? (
                      <IconButton
                        ...
                        className={classes.smallContainer}
                        disabled={!videoVisible || windowConsumer === consumer.id}
                        size="small"
                        color="primary"
                        onClick={() => {
              ...
              <VideoView
                ...
                consumerCurrentSpatialLayer={consumer ? consumer.currentSpatialLayer : null}
                consumerCurrentTemporalLayer={consumer ? consumer.currentTemporalLayer : null}
                consumerPreferredSpatialLayer={consumer ? consumer.preferredSpatialLayer : null}
                consumerPreferredTemporalLayer={consumer ? consumer.preferredTemporalLayer : null}
        ...
        >
          <div className={classnames(classes.viewContainer)}>
              ...
              {browser.platform !== 'mobile' && (
                ...
                >
                  <Fab
                    ...
                    className={classes.fab}
                    disabled={!screenVisible || windowConsumer === screenConsumer.id}
            ...
            <VideoView
              ...
              consumerCurrentSpatialLayer={screenConsumer ? screenConsumer.currentSpatialLayer : null}
              consumerCurrentTemporalLayer={screenConsumer ? screenConsumer.currentTemporalLayer : null}
              consumerPreferredSpatialLayer={screenConsumer ? screenConsumer.preferredSpatialLayer : null}
              consumerPreferredTemporalLayer={screenConsumer ? screenConsumer.preferredTemporalLayer : null}

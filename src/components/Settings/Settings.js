...
const tabs = ['media', 'appearence', 'advanced'];
...
const Settings = ({ currentSettingsTab, settingsOpen, handleCloseSettings, setSettingsTab, classes }) => {
  const intl = useIntl();
  return (
    <Dialog
...
export default connect(mapStateToProps, mapDispatchToProps, null, {
  areStatesEqual: (next, prev) => {
    return (
      prev.room.currentSettingsTab === next.room.currentSettingsTab && prev.room.settingsOpen === next.room.settingsOpen
    );
  },

    ...
    <MuiDialogTitle disableTypography className={classes.dialogTitle} {...other}>
      ...
      {window.config.loginEnabled && (
        <Tooltip
          ...
          placement="left"
        >
          <IconButton aria-label="Account" className={classes.loginButton} color="inherit" onClick={onLogin}>
            {myPicture ? (
              <Avatar src={myPicture} className={classes.largeAvatar} />
            ) : (
              <AccountCircle className={classnames(classes.largeIcon, loggedIn ? classes.green : null)} />
            )}
          </IconButton>
        </Tooltip>
      )}
      ...
      >
        ...
        <DialogContent>
          <DialogContentText gutterBottom align="center">
            <FormattedMessage id="room.aboutToJoin" defaultMessage="You are about to join a meeting" />
          </DialogContentText>
          ...
          {!room.inLobby && room.overRoomLimit && (
            <DialogContentText className={classes.red} variant="h6" gutterBottom>
              <FormattedMessage id="room.overRoomLimit" defaultMessage={'The room is full, retry after some time.'} />
            </DialogContentText>
          )}
        </DialogContent>
        ...
        {!room.inLobby ? (
          <DialogActions>
            <Button
              ...
              color="secondary"
            >
              <FormattedMessage id="room.audioOnly" defaultMessage="Audio only" />
            </Button>
            <Button
              onClick={() => {
              ...
              color="secondary"
            >
              <FormattedMessage id="room.audioVideo" defaultMessage="Audio and Video" />
            </Button>
          </DialogActions>
        ) : (
          <DialogContent>
